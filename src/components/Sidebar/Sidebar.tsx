    ...
    <aside className="flex h-full w-72 flex-shrink-0 flex-col border-r border-edge bg-sidebar">
      ...
      <div className="border-t border-edge px-3 py-2.5">
        ...
        <div className="mt-2 flex gap-2">
          <button
            onClick={toggleBrain}
            className="flex flex-1 items-center justify-between rounded-lg px-3 py-2 text-sm text-brain hover:bg-brain/10"
          >
          ...
          <button
            ...
            title="Recycle bin"
            className="rounded-lg px-3 py-2 text-sm text-text-muted hover:bg-hover hover:text-text-primary"
          >
            🗑
          </button>
        </div>
