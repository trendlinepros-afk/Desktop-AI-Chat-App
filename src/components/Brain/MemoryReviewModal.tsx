      ...
      <div className="flex max-h-[85vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-edge bg-topbar shadow-2xl">
          ...
          {review && !errored && (
            <div className="space-y-4">
              ...
              {review.ideas.length > 0 && (
                <div className="rounded-lg border border-idea/30 bg-idea/10 p-3">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full rounded-lg border border-idea/30 bg-surface px-3 py-2 text-sm outline-none focus:border-idea"
                  />
                </div>
              )}
        ...
        <div className="flex items-center justify-end gap-2 border-t border-edge px-5 py-3">
          ...
          <button
            ...
            className="rounded-lg bg-idea px-4 py-2 text-sm font-medium text-white hover:bg-idea/90 disabled:opacity-40"
          >
